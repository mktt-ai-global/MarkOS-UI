...
import { mockAgents, mockNodes, mockSessions, mockSkills, mockSystemStatus } from '../lib/mock-data'
...
export default function Dashboard() {
  ...
  const isLive = nodesLive || sessionsLive || toolsCatalogLive || presenceLive || agentsLive
  const snapshotBadge = (
  ...
  return (
    <div className="space-y-3 md:space-y-4 animate-fade-in">
      <div className="rounded-2xl px-4 py-3 text-xs bg-info/10 text-info">
        Dashboard metrics are derived from live gateway snapshots when connected.
      </div>
